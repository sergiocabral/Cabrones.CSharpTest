...
namespace Cabrones.Test
{
    public class TestAutoFixtureExtensions
    {
        ...
        [Fact]
        public void
            FixtureMany_informando_total_de_resultados_deve_estar_acessível_de_qualquer_lugar_e_criar_valor_aleatório_de_qualquer_tipo()
        {
            // Arrange, Given
            // Act, When
        ...
        [Fact]
        public void
            FixtureMany_sem_parâmetro_deve_estar_acessível_de_qualquer_lugar_e_criar_valor_aleatório_de_qualquer_tipo()
        {
            // Arrange, Given
            // Act, When
