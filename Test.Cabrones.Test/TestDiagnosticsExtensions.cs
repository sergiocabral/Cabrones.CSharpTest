...
namespace Cabrones.Test
{
    public class TestDiagnosticsExtensions
    {
        ...
        public void AssertTheSameValueButTheSecondTimeIsFaster_Object_deve_funcionar_corretamente()
        {
            ...
            Action testarParaPassar = () =>
                instância.AssertTheSameValueButTheSecondTimeIsFaster("ClasseNetaPropriedadePúblicaComCache");
            Action testarParaFalhar = () =>
                instância.AssertTheSameValueButTheSecondTimeIsFaster("ClasseNetaPropriedadePúblicaSemCache");
        ...
        public void AssertTheSameValueButTheSecondTimeIsFaster_Type_deve_funcionar_corretamente()
        {
            ...
            Action testarParaPassar = () =>
                tipo.AssertTheSameValueButTheSecondTimeIsFaster("ClasseNetaPropriedadePúblicaComCacheEstática");
            Action testarParaFalhar = () =>
                tipo.AssertTheSameValueButTheSecondTimeIsFaster("ClasseNetaPropriedadePúblicaSemCacheEstática");
